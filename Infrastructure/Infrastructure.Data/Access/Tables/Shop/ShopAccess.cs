...
namespace Infrastructure.Data.Access.Tables.Shop
{
    public class ShopAccess 
    {
        #region Default Methods
        public static Infrastructure.Data.Entities.Tables.Shop.ShopEntity Get(int id)
        {
            ...
            {
                return new Infrastructure.Data.Entities.Tables.Shop.ShopEntity(dataTable.Rows[0]);
            }
            else
            {
                return null;
        ...
        public static List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity> Get()
        {
            var dataTable = new DataTable();
            using (var sqlConnection = new SqlConnection(Settings.GetConnectionString()))
            {
            ...
            if (dataTable.Rows.Count > 0)
            {
                return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.Shop.ShopEntity(x)).ToList();
            }
            else
            {
                return new List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity>();
            }
        }
        public static List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity> Get(List<int> ids)
        {
            if (ids != null && ids.Count > 0)
            {
                int maxQueryNumber = Settings.MAX_BATCH_SIZE;
                List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity> results = null;
                ...
                else
                {
                    ...
                    results = new List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity>();
        ...
        private static List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity> get(List<int> ids)
        {
            if (ids != null && ids.Count > 0)
            {
                var dataTable = new DataTable();
                using (var sqlConnection = new SqlConnection(Settings.GetConnectionString()))
                {
                    ...
                    sqlCommand.CommandText = $"SELECT * FROM [Shop] WHERE [id] IN ({queryIds})";
                    new SqlDataAdapter(sqlCommand).Fill(dataTable);
                }
        ...
        public static int Insert(Infrastructure.Data.Entities.Tables.Shop.ShopEntity item)
        {
            ...
            using (var sqlConnection = new SqlConnection(Settings.GetConnectionString()))
            {
                ...
                string query = "INSERT INTO [Shop] ([address],[banner],[created_at],[custom_url],[description],[email],[logo],[name],[phone],[updated_at])  VALUES (@address,@banner,@created_at,@custom_url,@description,@email,@logo,@name,@phone,@updated_at); ";
        ...
        public static int Insert(List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity> items)
        {
        ...
        private static int insert(List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity> items)
        {
            if (items != null && items.Count > 0)
            {
                int results = -1;
                using (var sqlConnection = new SqlConnection(Settings.GetConnectionString()))
                {
                    ...
                    {
                        i++;
                        query += " INSERT INTO [Shop] ([address],[banner],[created_at],[custom_url],[description],[email],[logo],[name],[phone],[updated_at]) VALUES ( "
        ...
        public static int Update(Infrastructure.Data.Entities.Tables.Shop.ShopEntity item)
        {
            int results = -1;
            using (var sqlConnection = new SqlConnection(Settings.GetConnectionString()))
            {
                sqlConnection.Open();
                string query = "UPDATE [Shop] SET [address]=@address, [banner]=@banner, [created_at]=@created_at, [custom_url]=@custom_url, [description]=@description, [email]=@email, [logo]=@logo, [name]=@name, [phone]=@phone, [updated_at]=@updated_at WHERE [id]=@id";
                var sqlCommand = new SqlCommand(query, sqlConnection);
        ...
        public static int Update(List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity> items)
        {
            if (items != null && items.Count > 0)
            {
                int maxParamsNumber = Settings.MAX_BATCH_SIZE / 11; // Nb params per query
        ...
        private static int update(List<Infrastructure.Data.Entities.Tables.Shop.ShopEntity> items)
        {
            if (items != null && items.Count > 0)
            {
                int results = -1;
        ...
        private static int delete(List<int> ids)
        {
            if (ids != null && ids.Count > 0)
            {
                ...
                using (var sqlConnection = new SqlConnection(Settings.GetConnectionString()))
                {
                    ...
                    string query = "DELETE FROM [Shop] WHERE [id] IN (" + queryIds + ")";
                    sqlCommand.CommandText = query;
